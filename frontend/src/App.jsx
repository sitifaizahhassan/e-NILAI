...
import AdminAnalisisPage from "./pages/AdminAnalisisPage";
...
function App() {
  return (
    <Routes>
      ...
      {/* Semua laluan guna GuruLayout bersatu */}
      ...
      {/* Laluan admin juga guna GuruLayout supaya sidebar bersatu */}
      <Route path="/admin" element={<GuruLayout />}>
        <Route index element={<AdminDashboardPage />} />
        <Route path="keberhasilan" element={<AdminKeberhasilanPage />} />
        <Route path="pengguna" element={<AdminUrusPenggunaPage />} />
        <Route path="analisis" element={<AdminAnalisisPage />} />
      </Route>
