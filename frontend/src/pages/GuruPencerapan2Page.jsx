...
export default function GuruPencerapan2Page() {
  ...
  async function uploadFail(jenis, file) {
    ...
    try {
      ...
      const filePath = `${targetGuruId}/pencerapan_2/${jenis}-${timestamp}-${safeName}`;
    ...
    <div style={s.page}>
      ...
      {(!isPentadbirOrAdmin || selectedGuruId) ? (
        ...
        <div style={s.placeholder}>
          <p style={s.placeholderText}>Sila pilih guru dari senarai di atas untuk melihat atau mengisi Pencerapan 2.</p>
        </div>
      )}
    </div>
  );
